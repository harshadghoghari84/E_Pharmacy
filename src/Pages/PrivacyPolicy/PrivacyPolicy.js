                ...
                <Container>
                    <Row>
                        <Col xs="12 text-center">
                            ...
                            <p className="broadcast-title mb-0 d-flex align-items-center justify-content-center"><Link to="/"><span className="d-flex align-items-center"><i className="ri-home-smile-2-line me-1"></i> Home</span></Link> <b className="mx-3">::</b> <span>Privacy Policy</span></p>
                        </Col>
                    </Row>
                </Container>
            </section>
