...
export default {
  ...
  updateUserProfile: gql`mutation UpdateUserProfile($fName: String, $lName: String, $mobile: String, $email: String) {
    updateUserProfile(fName: $fName, lName: $lName, mobile: $mobile, email: $email) {
      billing_detail {
        id
        userId
        fName
